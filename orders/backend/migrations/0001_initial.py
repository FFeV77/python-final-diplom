    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filename', models.FileField(blank=True, null=True, upload_to='uploads/', verbose_name='Файл')),
        ...
        migrations.AddConstraint(
            model_name='productinfo',
            constraint=models.UniqueConstraint(fields=('product', 'shop', 'model', 'external_id'), name='unique_product_info'),
        ),
        migrations.AddConstraint(
